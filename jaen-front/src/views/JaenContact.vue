      ...
      <div class="row justify-content-center">
        <div class="col-md-9 col-lg-8 col-xl-6">
          <div class="text-center mb-4">
            ...
            <p class="lead">아래 양식을 채워 메일을 보내주시면 확인 후 답변드리겠습니다.
            </p>
          </div>
          <form action="/forms/smtp.php" data-form-email novalidate>
            <div class="row">
              ...
              <div class="col-12">
                <div class="form-group">
                  <label>문의사항:</label>
                  <textarea class="form-control" name="contact-message" rows="10" placeholder="어떤 점이 궁금하신가요?"></textarea>
                </div>
              </div>
              <div class="col-12">
